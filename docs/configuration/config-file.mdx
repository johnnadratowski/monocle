...
| `markdown_viewer` | string | `""` | Rendered-markdown viewer launched by `Ctrl+p` for the current artifact or `.md` file. May include flags (e.g. `"glow -p"`). Empty falls back to [`glow`](https://github.com/charmbracelet/glow). |
